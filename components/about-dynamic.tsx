            ...
            <div>
              ...
              <div className="space-y-3 md:space-y-4 text-sm md:text-base text-muted-foreground leading-relaxed">
                ...
                <DynamicContent 
                  ...
                  fallback="Each product in our collection is thoughtfully formulated using nature's most powerful ingredients—from adaptogenic herbs like Ashwagandha to the ancient healing properties of black seed oil and raw honey." 
                />
                <DynamicContent 
                  sectionId="about-description-3" 
                  fallback="We're more than just a skincare brand. Through our wellness podcast and mindful approach to beauty, we're building a community dedicated to holistic self-care." 
                />
              </div>
            </div>
